# Generated by Django 4.0.2 on 2022-02-11 16:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drinks', models.ManyToManyField(through='products.Nutrition', to='products.Drink')),
            ],
            options={
                'db_table': 'sizes',
            },
        ...
        migrations.AddField(
            model_name='allergy',
            name='drinks',
            field=models.ManyToManyField(through='products.AllergyOfDrink', to='products.Drink'),
        ),
    ]
